...
function seed() {
  const products = [
    ...
    { id:"P007", name:"InvestOS — Capital Units", minAmount:25000, maxAmount:100000, minTerm:6, maxTerm:12, baseRate:24.0, monthlyRate:2.0, description:"TQA Ventures advisory platform capital units. Fee-based advisory receivable — excluded from ECL under IFRS 9. Standard debtor ageing applies.", repaymentType:"Amortising", arrangementFee:2.5, commitmentFee:0, gracePeriod:0, maxLTV:100, minDSCR:1.0, eligibleBEE:[1,2,3,4,5,6,7,8], eligibleIndustries:["All"], status:"Active", createdBy:"U001", createdAt:now-365*day, idealFor:"SMEs seeking structured advisory and capital raising support.", riskClass:"D", ecl:0, s1PD:0, lgd:0.01 },
  ];
        ...
        {page === "public_home" && <div>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:16, marginTop:24 }}>
            {[
              ...
              ["InvestOS Advisory","Structured advisory and capital raising support for growth-stage SMEs."],
            ].map(([title,desc],i)=>(
