...
const calcCompositeAIScore = (app, customer, loan, collections, comms) => {
  ...
  function renderPage() {
    ...
    switch (page) {
      case "dashboard": return wrap("Dashboard", <DashboardPageExtracted KPI={KPI} Btn={Btn} Badge={Badge} SectionCard={SectionCard} ProgressBar={ProgressBar} I={I} C={C} fmt={fmt} statusBadge={statusBadge} predictDelinquency={predictDelinquency} />);
      ...
      case "statutory": return wrap("Statutory Reporting", <StatutoryReportingPageExtracted statutoryReports={statutoryReports} loans={loans} settings={settings} canDo={canDo} updateStatutoryStatus={updateStatutoryStatus} KPI={KPI} Tab={Tab} Table={Table} Badge={Badge} SectionCard={SectionCard} Btn={Btn} ProgressBar={ProgressBar} statusBadge={statusBadge} fmt={fmt} I={I} C={C} />);
      ...
      case "admin": return wrap("Administration", <AdministrationPageExtracted Btn={Btn} SectionCard={SectionCard} Field={Field} Input={Input} Select={Select} Textarea={Textarea} Tab={Tab} Table={Table} Badge={Badge} InfoGrid={InfoGrid} I={I} C={C} fmt={fmt} statusBadge={statusBadge} ROLES={ROLES} PERMS={PERMS} APPROVAL_LIMITS={APPROVAL_LIMITS} SECURITY_INSTRUMENTS={SECURITY_INSTRUMENTS} />);
      case "products": return wrap("Products", <AdministrationPageExtracted Btn={Btn} SectionCard={SectionCard} Field={Field} Input={Input} Select={Select} Textarea={Textarea} Tab={Tab} Table={Table} Badge={Badge} InfoGrid={InfoGrid} I={I} C={C} fmt={fmt} statusBadge={statusBadge} ROLES={ROLES} PERMS={PERMS} APPROVAL_LIMITS={APPROVAL_LIMITS} SECURITY_INSTRUMENTS={SECURITY_INSTRUMENTS} />);
      case "settings": return wrap("Settings", <AdministrationPageExtracted Btn={Btn} SectionCard={SectionCard} Field={Field} Input={Input} Select={Select} Textarea={Textarea} Tab={Tab} Table={Table} Badge={Badge} InfoGrid={InfoGrid} I={I} C={C} fmt={fmt} statusBadge={statusBadge} ROLES={ROLES} PERMS={PERMS} APPROVAL_LIMITS={APPROVAL_LIMITS} SECURITY_INSTRUMENTS={SECURITY_INSTRUMENTS} />);
