...
import { authSignIn, authSignUp, authSignOut, authGetUser, authOAuthUrl } from "../../lib/supabase.js";
import { SYSTEM_USERS, ROLES } from "../../constants/roles.js";
...
export function AuthProvider({ children }) {
  ...
  const handleSignUp = async () => {
    setAuthForm(f => ({ ...f, error: "" }));
    try {
      const res = await authSignUp(authForm.email, authForm.password);
