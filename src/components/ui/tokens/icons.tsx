/**
 * Icon design tokens — SVG glyphs used throughout the app.
 *
 * EXTRACTED FROM MONOLITH (UI Primitives sprint, May 2026).
 * Was previously inlined as `const I = {...}` in kwikbridge-lms-v2.jsx
 * line 310.
 *
 * Each icon is a React element using `currentColor` for the stroke,
 * so the colour follows the parent element's `color` style. Icons can
 * be used directly in JSX: `<Btn icon={I.plus}>Add</Btn>`.
 *
 * Adding a new icon: append a property here. Prefer 24×24 viewBox
 * with strokeWidth 1.6, sized to 16-18px wide for consistency.
 */
